...
class orderSystem extends Controller
{
    ...
    public function postOrderConfirmation(Request $req){
        ...
        return redirect()->route('pages.indexPage')->withInfo('Your order has been accepted');
    }
    ...
    {
        $category=Food::select('category')->orderBy('created_at', 'asc')->get();
        return view('pages.indexPage',['catedories'=>$category]);
    }
}
