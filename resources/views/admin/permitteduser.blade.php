...
<div class="d-flex justify-content-center">
    <form class="form-inline">
        ...
        {{ csrf_field() }}
        <input type="submit" formaction="{{ route('adminEmail.search') }}" formmethod="GET" class="btn btn-primary mb-2 mr-sm-2" value="Search">
        <input type="submit" formaction="{{ route('adminEmail.create') }}" formmethod="POST" class="btn btn-primary mb-2 mr-sm-2" value="Create">
    </form>
</div>
    ...
    <table class="table table-hover">
        ...
        @foreach($emails as $email)
            <tr>
                ...
                <td class="text-center"><a href="{{route('adminEmail.delete',['id'=>$email->id])}}"><i class="fa fa-trash-alt"></i></a></td>
            </tr>
            @php
                $i++
            @endphp
