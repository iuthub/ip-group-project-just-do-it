    ...
    <body>
        ...
        <form enctype="multipart/form-data" action="{{ route('postAddFood') }}" method="POST">
            ...
            <div class="form-group">
                ...
                <input list="categoryList" class="form-control" id="category" placeholder="Enter food category" name="category" required>
            ...
            <div class="form-group">
                ...
                <input type="number" class="form-control" id="price" min="0" value="" name="price" placeholder="Enter price" required>
            </div>
