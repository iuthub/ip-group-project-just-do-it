        ...
        <section class="px-md-5 mx-md-5 text-center text-lg-left dark-grey-text">
          ...
          <div class="row">
            ...
            <div class="col-md-6 mb-4 mb-md-0">
              ...
              <p class="text-muted">Not for nothing people from all over the world like and honor the Uzbek cuisine. It is one of the most savoury and various in tastes cuisine in Central Asia. Only names of appetizing Uzbek food make one’s mouth water. Plov, manti, shurpa, shashlik, lagman, samsa have such wonderful smell that one can’t resist the temptation to taste all these dishes piping hot.</p>
